      ...
      <div className="about__box">
        <div className="about__container container grid">
          ...
          <DotLottieReact
            ...
            src="https://lottie.host/1c948195-c71d-414b-a175-01e5fdc1066d/rUXKfe9Bk1.lottie"
            loop
            autoplay
          />
          ...
          <div className="about__data">
            ...
            <p className="about__description">
              ...
              <br />
              Me llamo
              <strong> Gonzalo Quiroga</strong>, tengo 24 años y soy de
              <strong> San Juan, Argentina.</strong>
              <br />
              <br />
              Soy
              <strong> Técnico Universitario en Programación</strong> con
              especialización en el stack
